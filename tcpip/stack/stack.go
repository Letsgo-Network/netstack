...
func (s *Stack) createNIC(id tcpip.NICID, name string, linkEP tcpip.LinkEndpointID, enabled, loopback bool, hooked bool, hookedAddress tcpip.Address, hookedPort uint16) *tcpip.Error {
	...
	n := newNIC(s, id, name, ep, loopback, hooked, hookedAddress, hookedPort)
...
func (s *Stack) CreateNIC(id tcpip.NICID, linkEP tcpip.LinkEndpointID, hooked bool, hookedAddress tcpip.Address, hookedPort uint16) *tcpip.Error {
	return s.createNIC(id, "", linkEP, true, false, hooked, hookedAddress, hookedPort)
}
...
func (s *Stack) CreateNamedNIC(id tcpip.NICID, name string, linkEP tcpip.LinkEndpointID, hooked bool, hookedAddress tcpip.Address, hookedPort uint16) *tcpip.Error {
	return s.createNIC(id, name, linkEP, true, false, hooked, hookedAddress, hookedPort)
}

// CreateNamedLoopbackNIC creates a NIC with the provided id and link-layer
// endpoint, and a human-readable name.
func (s *Stack) CreateNamedLoopbackNIC(id tcpip.NICID, name string, linkEP tcpip.LinkEndpointID, hooked bool, hookedAddress tcpip.Address, hookedPort uint16) *tcpip.Error {
	return s.createNIC(id, name, linkEP, true, true, hooked, hookedAddress, hookedPort)
}
...
func (s *Stack) CreateDisabledNIC(id tcpip.NICID, linkEP tcpip.LinkEndpointID, hooked bool, hookedAddress tcpip.Address, hookedPort uint16) *tcpip.Error {
	return s.createNIC(id, "", linkEP, false, false, hooked, hookedAddress, hookedPort)
}
...
func (s *Stack) CreateDisabledNamedNIC(id tcpip.NICID, name string, linkEP tcpip.LinkEndpointID, hooked bool, hookedAddress tcpip.Address, hookedPort uint16) *tcpip.Error {
	return s.createNIC(id, name, linkEP, false, false, hooked, hookedAddress, hookedPort)
}
